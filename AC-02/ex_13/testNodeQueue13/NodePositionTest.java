...
class NodePositionTest {
	...
	void test() {
		...
		//Criação de duas listas diferentes para comparação
		...
		//verifica se a posição p4 (que pertence a l1) faz parte a lista l e é esperado o
		// o retorno do erro InvalidPositionException
		assertThrows(InvalidPositionException.class, () -> {l.addAfter(p4, 11);});
